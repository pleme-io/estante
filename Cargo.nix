  ...
  internal = rec {
    ...
    crates = {
      ...
      "estante" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/estante; };
        authors = [
          "pleme-io"
        ];
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "rt-multi-thread" "macros" "fs" "process" "io-util" ];
          }
          {
            name = "tracing";
            packageId = "tracing";
      ...
      "estante-types" = rec {
        crateName = "estante-types";
        version = "0.1.1";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/estante-types; };
        libName = "estante_types";
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "frost-builtins" = rec {
        ...
        src = pkgs.fetchgit {
          url = "https://github.com/pleme-io/frost";
          rev = "efd11842c2ecc6851922f8687bd89cccd556fb42";
          sha256 = "0z56jzg6434zlan9k3nwlvzr2p0nvll3nqwgwjjpfr8d1cp17lni";
        };
      ...
      "octocrab" = rec {
        ...
        version = "0.43.0";
        edition = "2018";
        sha256 = "1pskcg7n4mag13zgmqy0caza97wgvdrqk5gp34rn0k1g69l7sli7";
        authors = [
